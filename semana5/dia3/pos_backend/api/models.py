...
class Plato(models.Model):
    ...
    categoria_id = models.ForeignKey(Categoria,related_name='plato',to_field='categoria_id',on_delete=models.RESTRICT,db_column='categoria_id',verbose_name='categoria')
