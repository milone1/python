# Generated by Django 3.2 on 2022-05-14 20:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria_id', models.ForeignKey(db_column='categoria_id', on_delete=django.db.models.deletion.RESTRICT, related_name='plato', to='api.categoria', verbose_name='categoria')),
            ],
        ),
    ]
